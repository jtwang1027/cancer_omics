...
1. Exploratory data analysis: (A) Examining time-dependent drug responses and identifying similarities in cell lines. (B) Looking at CNV data to identify potential sources of gene dysregulation.
